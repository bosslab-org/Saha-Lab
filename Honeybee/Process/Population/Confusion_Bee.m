function Conf_fig = Confusion_Bee(data,train_stimuli,test_stimuli,Confusion_title,res,acc)
...
xticks(1:numel(test_stimuli));
yticks(1:numel(train_stimuli));
xticklabels(test_stimuli);
yticklabels(train_stimuli);
xtickangle(45);
ytickangle(45);
Conf_axes.FontSize = 16;
xlabel('Target Odor', 'FontSize', 18)
ylabel('Training Template', 'FontSize', 18)
