function [data_filt, stim_on, stim_off, sample_rate] = read_intan_2022(stimulus, filepath, readpath, exp_path)
...
for cycle_trials = 1:length(trials)
    ...
    if size(board_dig_in_data,1) == 2
        ...
        stim_on_temp(cycle_trials) = 5;
        stim_off_temp(cycle_trials) = stim_on_temp(cycle_trials)+4;
    end
