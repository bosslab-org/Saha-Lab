...
if input_files == 'm'
    ...
    if stimulus == 'c'
        ...
        if include_odors == 'n'
            order = [6 1 2 3 5];
            writepath_temp = 'NoOdors';
        elseif include_odors == 'y'
            order = [6 1 2 3 5 4 7];
            writepath_temp = 'WithOdors';
        end        
%         Colors = [255,0,0 ; 0,255,0 ; 150,150,150 ; 255,255,0 ; 0,0,0 ; 0,0,255 ; 0,255,255]./255; 
        ...
        if file_type == 'r'
            writepath = [writepath '/RMS_' writepath_temp];
            filename = 'R2000_S2000_b50_Cell_Culture';
            var_ext = 'mean_data_master';
        elseif file_type == 'ss' 
            writepath = [writepath '/SS_' writepath_temp];
        ...
        if daywise_comp == 'y'
            ...
            day = [filename '_Day' num2str(select_day)];
            writepath_temp = ['Day' num2str(select_day)];
    ...
    elseif stimulus == 'o' || stimulus == 'h'
        ...
        if stimulus == 'o'
            ...
            if file_type == 'r'
                ...
                filename = 'R2000_S2000_b50_Odors.mat';
                var_ext = 'mean_data_master';
            elseif file_type == 'ss'
        ...
        elseif stimulus == 'h'
            ...
            if file_type == 'r'
                writepath = [writepath '/RMS'];
                filename = 'R2000_S2000_b50_Honeybee';
                var_ext = 'mean_data_master';
            elseif file_type == 'ss' 
                writepath = [writepath '/SS'];
                filename = ' ';
...
if save_figs == 'y'   
    if exist('writepath_temp')
        writepath = [writepath '/' file_name '/' writepath_temp '/' num2str(time(1)) 'to' num2str(time(2))];
    else
        writepath = [writepath '/' file_name '/' num2str(time(1)) 'to' num2str(time(2))];
    end        
    if ~exist(writepath)
        mkdir(writepath)
    end
